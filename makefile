...
bin/CAexplorer: build/CAexplorer.o build/printTitle.o build/ICA.o
	gcc build/CAexplorer.o build/printTitle.o build/ICA.o -o bin/CAexplorer

build/CAexplorer.o: src/CAexplorer.c src/printTitle.h src/CA/ICA.h
